...
#error "Q4 certified core requires a generated LUT-range certificate"
#endif
...
/* Branchless symmetric round-to-nearest for Q4. */
...
/* Safe only because the generated header certifies every effective input state. */
